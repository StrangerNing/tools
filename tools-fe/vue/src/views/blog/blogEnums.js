...
export default {
  ...
  timelineTypeEnum: new Enum().add('bg-success', '绿色', 1).add('bg-info', '蓝色', 2).add('bg-warning', '黄色',3).add('bg-danger', '红色', 4),
  timelineStatusEnum: new Enum().add('enable', '启用', 1).add('disable', '禁用', 0)
}
